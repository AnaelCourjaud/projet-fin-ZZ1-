...
int reconnaitreCompo(int compo[3], int listeCompo[20][NBENNEMIVAGUE], combattant_t *tableauCombattants[NBRMAXCOMBATTANTS])
{
    ...
    while (combReconnu != 3)
    {
        indice ++;
        int j = 0;
        while((j<NBENNEMIVAGUE)&&(listeCompo[indice][j]==compo[j])) j++;
        combReconnu = j;
    }
    return indice;
}
...
int main()
{
    ...
    int listeCompo[20][3] = {{BUGFIRE, -1, -1}, {FLY, -1, -1}, {MANTIS, -1, -1}, {BUGFIRE, BUGFIRE, -1}, {FLY, FLY, -1}, {MANTIS, MANTIS, -1}, {BUGFIRE, FLY, -1}, {BUGFIRE, MANTIS, -1}, {FLY, MANTIS, -1}, {BUGFIRE, BUGFIRE, BUGFIRE}, {FLY, FLY, FLY}, {MANTIS, MANTIS, MANTIS}, {BUGFIRE, BUGFIRE, FLY}, {BUGFIRE, BUGFIRE, MANTIS}, {FLY, FLY, BUGFIRE}, {FLY, FLY, MANTIS}, {MANTIS, MANTIS, BUGFIRE}, {MANTIS, MANTIS, FLY}, {BUGFIRE, FLY, MANTIS}};
    int compo[3];

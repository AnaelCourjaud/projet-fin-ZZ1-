...
void draw(SDL_Renderer* renderer, int pos) {                                 // Je pense que vous allez faire moins laid :)
  ...
  rectangle.x = pos;                                                  // x haut gauche du rectangle
  rectangle.y = pos;                                                  // y haut gauche du rectangle
...
*/
  ...
  for (float angle = 0; angle < 2 * M_PI; angle += M_PI / 4000) {      
    ...
    SDL_RenderDrawPoint(renderer,                                   
                        200+pos + 100 * cos(angle),                     // coordonnée en x
                        200+pos + 150 * sin(angle));                    //            en y   
  }
}
...
int main(int argc, char** argv) {
  ...
  draw(renderer,i);                                      // appel de la fonction qui crée l'image  
